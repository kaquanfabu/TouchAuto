...
TouchAuto_CFLAGS = -fobjc-arc -Wno-deprecated-declarations -DTROLLSTORE -I$(PTFAKETOUCH_LOCAL_PATH)/PTFakeTouch/PTFakeTouch -I$(PTFAKETOUCH_LOCAL_PATH)/PTFakeTouch/addition
...
TouchAuto_FILES = tweak/TouchAuto.m \
                  ...
                  $(PTFAKETOUCH_LOCAL_PATH)/PTFakeTouch/PTFakeTouch/PTFakeMetaTouch.m \
